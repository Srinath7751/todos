    ...
    case hasCategoryAndStatus(request.query):
      if (
        ...
        if (
          ...
          data = await datbase.all(getTodoQuery);
...
app.put("/todos/:todoId/", async (request, response) => {
  ...
  switch (true) {
    case requestBody.status !== undefined:
      if (status === "TO DO" || status === "IN PROGRESS" || status === "DONE") {
        updatedTodoQuery = `UPDATE todo SET todo='${todo}',priority='${priority}',status='${status}',category='${category}', due_date='${dueDate}' where id=${todoId};`;
    ...
    case requestBody.dueDate !== undefined:
      if (isMatch(dueDate, "yyyy-MM-dd")) {
        ...
        updatedTodoQuery = `UPDATE todo SET todo='${todo}',priority='${priority}',status='${status}',category='${category}', due_date='${newDueDate}' where id=${todoId};`;
